...
problem_slug: "sorting-stones"
problem_url: "https://www.hackerrank.com/contests/noi-2019-day-1/challenges/sorting-stones"
---
...
Each of the following **N** lines have a single integer, **A<sub>i</sub>** the weight of the rock in the **i<sup>th</sup>** position. Each weight is a number between 1 and N and **all weights** are **different**.
